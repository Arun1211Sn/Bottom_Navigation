...
public class CustomBottomNavigation extends BottomNavigationView {
    ...
    private void init() {
        ...
        //mPaint.setShader(new LinearGradient(0, 0, getWidth(), getHeight(), ContextCompat.getColor(getContext(),R.color.gradient1), ContextCompat.getColor(getContext(),R.color.gradient2), Shader.TileMode.CLAMP));
